...
Skill        | Note
-------------|-----------------------------------
Back-End          | Spring framework, Mybatis or Query 기반으로 간단한 Backend API 서버 자체 개발 가능
Front-End      |  Image 관리 및 Docker, Docker-Compose를 통한 서버 배포 경험
DB/Framework | Next.js 기반으로 확장 가능하고 사용자 친화적인 웹 애플리케이션 개발 가능
Tools       | 효율적인 ERD 설계 및 SQL 쿼리 작성 능력
